...
import type { UpdateMediaTypeCommand } from '../../domain/media-types/update-media-type.js'
import { createUpdateMediaTypeCommand } from '../../domain/media-types/update-media-type.js'
