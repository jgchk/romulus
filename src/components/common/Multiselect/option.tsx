...
const MultiselectOption = <T extends HasId>({
  ...
  return (
    <li
      className='multiselect-option cursor-pointer rounded border border-transparent p-1 px-1.5 text-sm text-gray-800 hover:bg-gray-200 focus:border-secondary-500 active:bg-gray-300'
      onClick={() => handleClick()}
    >
      {children}
    </li>
