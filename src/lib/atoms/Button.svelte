...
<button
  ...
  class={tw(
    ...
    kind === 'solid' &&
      cn(
        'border-transparent text-black disabled:bg-gray-500 disabled:text-gray-700',
    ...
    kind === 'outline' &&
      cn(
        'bg-transparent disabled:border-gray-500 disabled:bg-transparent disabled:text-gray-500',
    ...
    kind === 'text' &&
      cn(
        'border-transparent bg-transparent disabled:bg-transparent disabled:text-gray-500',
        layer === 700 && 'hover:bg-gray-600',
        layer === 800 && 'hover:bg-gray-700',
