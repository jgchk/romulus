...
<button
  ...
  {type}
  class={tw(
    'rounded border border-transparent bg-gray-900 bg-opacity-0 p-1 text-primary-500 outline-none transition hover:bg-opacity-10 focus:border-secondary-500 dark:bg-gray-100 dark:bg-opacity-0',
